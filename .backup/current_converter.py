...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, *args, obj=None, **kwargs):
        ...
        self.load_images_from_folder_Button.clicked.connect(self.get_image_files_from_folder)
        
        self.load_images_Path.mouseDoubleClickEvent = self.open_file_dialog_on_double_click
        self.load_images_from_folder_Path.mouseDoubleClickEvent = self.open_file_dialog_on_double_click
    ...
    def load_images(self):
        ...
        if files:
            ...
            self.listWidget.clear()  # Liste leeren
            for file in files:
                self.listWidget.addItem(QListWidgetItem(file))  # Bilder in Liste einfügen
    ...
    # Zeigt den Ordnerdialog und gibt den ausgewählten Ordnerpfad zurück
        ...
        if folder_path:
            self.image_paths = folder_path  # Liste speichern
            self.listWidget.clear()  # Liste leeren
    ...
    def display_images_in_list(self, files):
        ...
        self.listWidget_images_source.clear()  # Leere die Liste
        for file in files:
            # Füge jedes Bild zur ListWidget hinzu
            self.listWidget_images_source.addItem(QListWidgetItem(file))
    ...
    def convert_images(self):
        ...
        self.listWidget_ico_Output.clear()  # 
